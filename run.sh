...
python main.py --gpu 0 --test --dataset refcoco+ --pretrain "/home/ubuntu/VGTR/store/logs_co_attn_encoder/resume_17/model/model_refcoco_batch_48/model_refcoco_best.pth.tar" --data_perc 0.99 --save_data "/home/ubuntu/VGTR/store/logs_co_attn_encoder/output_refcoco_plus/" --split testB